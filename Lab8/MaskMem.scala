//Memory with Mask
//write method supports three argument with SyncReadMem that is address, data, mask. 
//Masking is required when performing byte and half-word access from word addressable location.
